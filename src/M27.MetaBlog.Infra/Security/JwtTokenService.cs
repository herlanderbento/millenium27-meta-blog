...
public class JwtTokenService : ITokenProvider
{
    ...
    private readonly int _accessTokenExpirationMinutes = 30;

    public JwtTokenService(IConfiguration configuration)
    {
        _secretKey = configuration["Jwt:SecretKey"] ?? throw new ArgumentNullException("JWT Secret is missing in configuration.");
    }
